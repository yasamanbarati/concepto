...
export const ImportantNews: ImportantNewsProps[] = [
  {
    id: 101,
    description: "اولین رویداد چالش نوآوری در شهرهای آسیایی",
    image: "/images/Important_news1.png",
  },
  {
    id: 102,
    description: "استارت آپ هایی که باعث رشد مالی شدند",
    image: "/images/Important_news2.png",
  },
  {
    id: 103,
    description: "فرصت سرمایه گذاری در تیم های استارت آپی و دانش بنیان",
    image: "/images/Important_news3.png",
  },
];
export const News: ImportantNewsProps[] = [
  {
    id: 0,
    title: "سکوی پرتاب امید",
    timestamp: "5 فروردین 1403",
    description: "سکوی پرتاب امید در حوزه فناوری، محصولات خلاق و نوآور است.",
  },
  {
    id: 1,
    title: "پایداری مدیران بورس تهران از تجزیه کالا",
    timestamp: "22 اسفند 1401",
    description:
      "در گزارش کل بورس کالا، مدیران بازار و سایر فعالان از شرکت جدیدالورود دفاع کردند.",
  },
  {
    id: 2,
    title: "برگزاری دوره دوم نمایشگاه آذربایجان",
    timestamp: "20 اسفتد 1402",
    description:
      "دوره دوم نمایشگاه آذربایجان با هدف رفع نیازهای فناوری و مسائلی در حوزه آذربایجان برگزار خواهد شد.",
  },
  {
    id: 3,
    title: "گزارش رویداد فاینوس راه اتاق بازرگانی تهران",
    timestamp: "18 اسفتد 1402",
    description:
      "مرکز نوآوری فاینوس تهران به هدف حمایت از کارآفرینان و ایجاد فضای کار به فعالیت خود ادامه می‌دهد.",
  },
  {
    id: 4,
    title: "اکوسیستم تکنولوژی املاک کشور در حال توسعه است",
    timestamp: "15 اسفتد 1402",
    description:
      "در سال ۱۳۹۷ این امکان فراهم شد تا کارگران این شکل را داشته باشند.",
  },
  {
    id: 5,
    title: "سرمایه‌گذاری در حوزه گردشگری سیمرغ",
    timestamp: "14 اسفند 1402",
    description:
      "سرمایه‌گذاری سیمرغ بر روی گردشگری و رویدادهای مربوط به صنعت گردشگری سیمرغ است.",
  },
  {
    id: 6,
    title: "تجدید فراخوان کلان طرح‌های توسعه فناوری حوزه زیست فناوری",
    timestamp: "5 بهمن 1401",
    description:
      "طرح‌های کلان حوزه زیست فناوری با هدف توسعه علمی و فناوری به اجرا درآمده است.",
  },
  {
    id: 7,
    title: "گزارش هفتمین جشنواره فناوری اطلاعات کشور",
    timestamp: "2 بهمن 1401",
    description:
      "جشنواره فناوری اطلاعات با هدف معرفی توانمندی‌های ملی برگزار شد.",
  },
];
